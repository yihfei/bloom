...
export async function SectionCards() {
  const totalBrews = await getNumberOfBrews();
  const avgBrewPrice = await getAverageBrewPrice();
  const totalTimeBrewing = await getTotalTimeSpentBrewing();
  const totalCoffeeBeans = await getCoffeeBeanCount();
  return (
